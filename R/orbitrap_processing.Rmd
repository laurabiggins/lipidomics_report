...
output_file: lip
params:
 # metadata_file: D:/projects/lipidomics/example_data/Bebiana_July/metadata.txt
  #input_file: D:/projects/lipidomics/example_data/Bebiana_July/alldata.lipidomics_summaryCorr.tsv
...
assertthat::assert_that(
  ...
  msg = paste0(
    ...
    paste0(colnames(all_data)[!(colnames(all_data) %in% c(meta_info$sample_name, params$lipid_name_col))], collapse = ", ")
  )
)
```
...
# median values per subclass, including abundance categories
...
# here as we need some of the t-statistic values for the forest plot. 
# 
...
Subclasses that did not fit the assumptions for two-sample t_tests may not be shown in these plots.
