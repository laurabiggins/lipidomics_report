...
ratio_wrapper <- function(df, conditions){
  ...
  res <- mratios::ttestratio(df[[conditions[1]]], df[[conditions[2]]], alternative="two.sided")
  #conf <- ttestratio(df[[conditions[1]]], df[[conditions[2]]], alternative="two.sided")$conf.int
