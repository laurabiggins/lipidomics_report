...
The red point shows the ratio while the lines show the confidence interval. If the confidence interval does not span 0, the difference between the 2 conditions will be significant.
